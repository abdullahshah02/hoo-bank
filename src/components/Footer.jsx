  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        ...
        <div className='flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10'>
          {footerLinks.map(footerLink => (
            <div key={footerLink.key} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
              <h4 className='font-poppins leading-[27px] text-white font-medium text-[18px]'>
                {footerLink.title}
              </h4>
      ...
      <div className='flex md:flex-row flex-col w-full justify-between items-center pt-6 border-t-[1px] border-t-[#3f3e45]'>
        <p className='font-poppins leading-[27px] text-white font-normal text-center text-[18px]'>
